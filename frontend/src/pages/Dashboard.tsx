...
export const DashboardPage = () => {
  ...
  return React.createElement('div',
    ...
    React.createElement('div',
      { className: 'mb-8' },
      React.createElement('h1', { className: 'text-3xl font-bold gradient-text mb-2' }, 'Tableau de bord'),
      React.createElement('p', { className: 'text-slate-400' }, 'Bienvenue dans votre centre de contrôle AEGIS')
    ),
