...
function App() {
  ...
  if (isFullPage) {
    return React.createElement(Routes, {},
      React.createElement(Route, { path: '/connect-platforms', element: React.createElement(ConnectPlatformsPage) }),
      React.createElement(Route, { path: '/connected-accounts', element: React.createElement(ConnectedAccountsPage) }),
      React.createElement(Route, { path: '/campaigns/:platform', element: React.createElement(PlatformCampaignsPage) })
    )
  }
      ...
      React.createElement('main',
        ...
        React.createElement('div', { className: 'p-8' },
          React.createElement(Routes, {},
            React.createElement(Route, { path: '/agents', element: React.createElement(AgentsPage) }),
            React.createElement(Route, { path: '/tasks', element: React.createElement(TasksPage) }),
